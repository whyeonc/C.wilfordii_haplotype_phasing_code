...
fread('/filer-dg/agruppen/dg2/cho/cwy/assembly/gmap_index/cw_hap_phased_table.txt')->x
...
fread(cmd="grep '^S' /filer-dg/agruppen/dg2/cho/cw/assembly/cw_hap_phased.hic.p_utg.noseq.gfa | cut -f 2,5 | tr ':' '\\t' | cut -f 1,4", head=F) -> cov
...
readRDS('/filer-dg/agruppen/dg2/cho/cw/guide_map/cw_pseudopopseq.Rds') -> pg

#read unitig lengths
f <- '/filer-dg/agruppen/dg2/cho/cw/assembly/cw_hap_phased.hic.p_utg.fa.fai'
...
#read Hi-C map
dir <- '/filer-dg/agruppen/dg2/cho/cw/mapping/hic'
